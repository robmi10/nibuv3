...
const Ascii_3 = ({video, gif, width_input, height_input}) => {
    ...
    const geometry = new THREE.PlaneGeometry(512, 512);
       ...
       */
        ...
        */
        ...
        const texture = new THREE.Texture(videoRef.current)
  ...
  return (
    <>
          ...
          {/* 
            ...
            <video style = {{display: "none"}} ref={videoRef} autoPlay loop>
